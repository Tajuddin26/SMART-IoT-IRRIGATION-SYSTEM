...
Temperature
Relative Humidity
Soil Moisture The collected data is sent to ThingSpeak Cloud, and the irrigation motor is automatically controlled based on soil moisture conditions and user-defined irrigation settings.
✨ Features
...
ddaaa356-085d-42c7-baed-414d6f7dc8c8
⚙️ Working Principle
...
3. Exit
Select Option:
WhatsApp Image 2026-09-12 at 1 09 23 PM
